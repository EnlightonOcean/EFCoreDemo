...
namespace EFCoreApp_DataAccess.Data.Migrations
{
    ...
    [Migration("20220203021530_AddManytoManyRelationshipTestBookAndTestAuthor")]
    partial class AddManytoManyRelationshipTestBookAndTestAuthor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreApp_DataAccess.Entities.Fluent_Book", b =>
                {
                    ...
                    b.HasOne("EFCoreApp_DataAccess.Entities.Fluent_Publisher", "Publisher")
            ...
            modelBuilder.Entity("EFCoreApp_DataAccess.Entities.Fluent_BookAuthor", b =>
                {
                    b.HasOne("EFCoreApp_DataAccess.Entities.Fluent_Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreApp_DataAccess.Entities.Fluent_Book", "Book")
                        .WithMany("Authors")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TestAuthorTestBook", b =>
                {
                    b.HasOne("EFCoreApp_DataAccess.Entities.TestAuthor", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreApp_DataAccess.Entities.TestBook", null)
                        .WithMany()
